// Hetzner brand mark (their red "H"), inlined so it works under the app's CSP and
// offline — never hotlinked from a CDN.
export function HetznerLogo({ size = 16 }: { size?: number }) {
	return (
		<svg
			width={size}
			height={size}
